# PAM-Manager
*nix PAM Manager - a graphical tool for managing Linux/Unix PAM (Pluggable Authentication Modules)
configuration.

It does not aim to be a PAM module itself. It works on top of PAM configuration and provides GUI,
data models, validation, templates and tools for working with individual PAM services, modules
